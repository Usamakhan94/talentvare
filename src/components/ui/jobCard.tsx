...
const JobCard = ({ jobItem }: JobItemProp) => {
  ...
  return (
    <Card className="2xl:px-5 px-4 py-2.5 gap-3.75 rounded-[0.625rem] justify-between">
      <div className="flex flex-col gap-1.25">
        ...
        <div className="flex items-center gap-2.5">
          <div className="bg-[#FAFAFA] rounded-[0.625rem] w-10 h-10 flex items-center justify-center">
            <img src={jobItem.companyIcon} alt="" width="23" height="22" />
          </div>
          <div>
        ...
        <div className="flex items-center gap-2.5">
          <span className="text-muted max-w-3 [&_svg]:max-h-3 [&_svg]:w-full">
            <MapPin />
          </span>
      ...
      <div className="flex justify-between items-center">
        <Button className="font-normal text-white px-7.5 py-2.5 leading-none text-[0.75rem]">
          Apply Now
        </Button>
        <span
