...
const JobsPosted = ({
  ...
  return (
    <div className="flex flex-col gap-3.75 pb-6.25 border-b border-[#E9ECEF]">
      <div className="flex justify-between items-center ">
        <div className="flex items-center sm:flex-nowrap flex-wrap sm:gap-3.75 gap-2">
      ...
      <div className="xl:grid hidden xl:grid-cols-5 grid-cols-4 gap-3">
